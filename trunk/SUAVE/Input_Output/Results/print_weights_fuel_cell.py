...
# print_weights_fuel_cell.py 

# Created: SUAVE team
# Updated: Dec 2019, S. Nicolay
...
# ----------------------------------------------------------------------
## @ingroup Input_Output-Results
def print_weight_breakdown_fuel_cell(config,filename = 'weight_breakdown.dat'):
    ...
    #fid.write(' CENTER OF GRAVITY \n')
    #fid. write(' x_cg = ' + str(round(config.mass_properties.center_of_gravity[0][0], 3)) + ' m\n')
    #fid. write(' y_cg = ' + str(round(config.mass_properties.center_of_gravity[0][1], 3)) + ' m\n')
    #fid. write(' z_cg = ' + str(round(config.mass_properties.center_of_gravity[0][2], 3)) + ' m\n')
